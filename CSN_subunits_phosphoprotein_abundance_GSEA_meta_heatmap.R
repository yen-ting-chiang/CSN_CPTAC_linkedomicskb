## =========================================================================
##  CSN Subunits Phosphoprotein Abundance GSEA Meta-Analysis Heatmaps
##  Data source: Meta-analysis output from CSN_subunits_phosphoprotein_abundance_GSEA_meta
##
##  Purpose:
...
INPUT_DIR <- file.path(BASE_DIR, "CSN_subunits_phosphoprotein_abundance_GSEA_meta")
OUT_ROOT <- file.path(BASE_DIR, "CSN_subunits_phosphoprotein_abundance_GSEA_meta_heatmap")
