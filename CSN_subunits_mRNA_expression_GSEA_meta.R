## =========================================================================
##  CSN Subunits mRNA expression GSEA Meta-Analysis
##  Data source: GSEA results from CSN_subunits_mRNA_expression_GSEA
##
##  Purpose:
##    Perform cross-dataset meta-analysis using Stouffer's z-score method 
##    with Benjamini-Hochberg FDR correction.
##    This script reads the output from CSN_subunits_mRNA_expression_GSEA.R
...
INPUT_DIR <- file.path(BASE_DIR, "CSN_subunits_mRNA_expression_GSEA")
OUT_ROOT <- file.path(BASE_DIR, "CSN_subunits_mRNA_expression_GSEA_meta")
