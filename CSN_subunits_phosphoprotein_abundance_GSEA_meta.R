## =========================================================================
##  CSN Subunits Phosphoprotein Abundance GSEA Meta-Analysis
##  Data source: GSEA results from CSN_subunits_phosphoprotein_abundance_GSEA
##
##  Purpose:
##    Perform cross-dataset meta-analysis using Stouffer's z-score method 
##    with Benjamini-Hochberg FDR correction.
##    This script reads the output from CSN_subunits_phosphoprotein_abundance_GSEA.R
...
INPUT_DIR <- file.path(BASE_DIR, "CSN_subunits_phosphoprotein_abundance_GSEA")
OUT_ROOT <- file.path(BASE_DIR, "CSN_subunits_phosphoprotein_abundance_GSEA_meta")
