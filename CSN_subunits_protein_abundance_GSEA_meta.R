## =========================================================================
##  CSN Subunits Protein Abundance GSEA Meta-Analysis
...
##    This script reads the output from CSN_subunits_protein_abundance_GSEA.R
...
INPUT_DIR <- file.path(BASE_DIR, "CSN_subunits_protein_abundance_GSEA")
OUT_ROOT <- file.path(BASE_DIR, "CSN_subunits_protein_abundance_GSEA_meta")
