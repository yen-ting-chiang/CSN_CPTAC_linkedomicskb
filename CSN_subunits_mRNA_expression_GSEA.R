## =========================================================================
##  CSN Subunits mRNA Expression Preranked GSEA
##  Data source: limma DEG results from CSN_subunits_mRNA_expression_limma_DEG
##
##  Purpose:
...
DEG_ROOT  <- file.path(BASE_DIR, "CSN_subunits_mRNA_expression_limma_DEG")
OUT_ROOT  <- file.path(BASE_DIR, "CSN_subunits_mRNA_expression_GSEA")
...
message("\n============================================================")
message("  CSN Subunits mRNA Expression Preranked GSEA")
...
if (length(deg_files) == 0) {
  stop("No DEG result files found in: ", DEG_ROOT,
       "\nPlease run CSN_subunits_mRNA_expression_limma_DEG.R first.")
}
